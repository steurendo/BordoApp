    ...
    DialogBox(onDismissRequest = onDismiss) {
        Column(
            ...
            CustomButton(
                ...
                Text(text = stringResource(id = R.string.button_generate_album))
            }
        }
    }
}
...
@PreviewTheme
@Composable
private fun GenerateAlbumDialogBoxPreview() {
    BordoAppTheme {
        GenerateAlbumDialogBox(
            onDismiss = {},
            onConfirm = {},
            message = "Do you want to generate album \"Test Album 2\"?"
        )
    }
}